...
func NewViewedArchivedIncident(res *ArchivedIncident, view string) *archivedincidentviews.ArchivedIncident {
	...
	case "default", "":
		...
		vres = &archivedincidentviews.ArchivedIncident{p, "default"}
	case "extended":
		p := newArchivedIncidentViewExtended(res)
		vres = &archivedincidentviews.ArchivedIncident{p, "extended"}
	case "source":
		p := newArchivedIncidentViewSource(res)
		vres = &archivedincidentviews.ArchivedIncident{p, "source"}
	}
	return vres
}
...
func NewViewedArchivedIncidentList(res *ArchivedIncidentList, view string) *archivedincidentviews.ArchivedIncidentList {
	...
	case "default", "":
		...
		vres = &archivedincidentviews.ArchivedIncidentList{p, "default"}
	case "extended":
		p := newArchivedIncidentListViewExtended(res)
		vres = &archivedincidentviews.ArchivedIncidentList{p, "extended"}
	}
	return vres
}
...
func NewViewedEscalations(res *Escalations, view string) *archivedincidentviews.Escalations {
	var vres *archivedincidentviews.Escalations
	switch view {
	case "default", "":
		p := newEscalationsView(res)
		vres = &archivedincidentviews.Escalations{p, "default"}
	}
	return vres
}
...
func NewViewedResolutions(res *Resolutions, view string) *archivedincidentviews.Resolutions {
	var vres *archivedincidentviews.Resolutions
	switch view {
	case "default", "":
		p := newResolutionsView(res)
		vres = &archivedincidentviews.Resolutions{p, "default"}
	}
	return vres
}
