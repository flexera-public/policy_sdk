...
func NewViewedApprovalRequest(res *ApprovalRequest, view string) *approvalviews.ApprovalRequest {
	...
	case "default", "":
		...
		vres = &approvalviews.ApprovalRequest{Projected: p, View: "default"}
	case "extended":
		p := newApprovalRequestViewExtended(res)
		vres = &approvalviews.ApprovalRequest{Projected: p, View: "extended"}
	}
	return vres
}
...
func NewViewedApprovalRequestList(res *ApprovalRequestList, view string) *approvalviews.ApprovalRequestList {
	...
	case "default", "":
		...
		vres = &approvalviews.ApprovalRequestList{Projected: p, View: "default"}
	case "extended":
		p := newApprovalRequestListViewExtended(res)
		vres = &approvalviews.ApprovalRequestList{Projected: p, View: "extended"}
	}
	return vres
}
