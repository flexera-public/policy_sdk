...
func NewViewedPolicyAggregate(res *PolicyAggregate, view string) *policyaggregateviews.PolicyAggregate {
	...
	case "default", "":
		...
		vres = &policyaggregateviews.PolicyAggregate{p, "default"}
	case "index":
		p := newPolicyAggregateViewIndex(res)
		vres = &policyaggregateviews.PolicyAggregate{p, "index"}
	case "source":
		p := newPolicyAggregateViewSource(res)
		vres = &policyaggregateviews.PolicyAggregate{p, "source"}
	case "link":
		p := newPolicyAggregateViewLink(res)
		vres = &policyaggregateviews.PolicyAggregate{p, "link"}
	}
	return vres
}
...
func NewViewedPolicyAggregateNonCatalog(res *PolicyAggregateNonCatalog, view string) *policyaggregateviews.PolicyAggregateNonCatalog {
	...
	case "default", "":
		...
		vres = &policyaggregateviews.PolicyAggregateNonCatalog{p, "default"}
	case "index":
		p := newPolicyAggregateNonCatalogViewIndex(res)
		vres = &policyaggregateviews.PolicyAggregateNonCatalog{p, "index"}
	case "link":
		p := newPolicyAggregateNonCatalogViewLink(res)
		vres = &policyaggregateviews.PolicyAggregateNonCatalog{p, "link"}
	}
	return vres
}
...
func NewViewedPolicyAggregateList(res *PolicyAggregateList, view string) *policyaggregateviews.PolicyAggregateList {
	...
	case "default", "":
		...
		vres = &policyaggregateviews.PolicyAggregateList{p, "default"}
	case "link":
		p := newPolicyAggregateListViewLink(res)
		vres = &policyaggregateviews.PolicyAggregateList{p, "link"}
	}
	return vres
}
