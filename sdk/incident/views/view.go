...
func ValidateIncidentList(result *IncidentList) (err error) {
	...
	case "extended":
		err = ValidateIncidentListViewExtended(result.Projected)
	default:
...
// ValidateIncidentListViewExtended runs the validations defined on
// IncidentListView using the "extended" view.
func ValidateIncidentListViewExtended(result *IncidentListView) (err error) {
	...
	if result.Items != nil {
		if err2 := ValidateIncidentCollectionViewExtended(result.Items); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
