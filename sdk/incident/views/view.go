...
type IncidentView struct {
	...
	ViolationDataFields []*DataFieldView
...
// DataFieldView is a type that runs validations on a projected type.
type DataFieldView struct {
...
// ActionView is a type that runs validations on a projected type.
...
var (
	...
	// ActionMap is a map of attribute names in result type Action indexed by view
	// name.
...
// ValidateIncident runs the validations defined on the viewed result type
// Incident.
func ValidateIncident(result *Incident) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateIncidentView(result.Projected)
	case "extended":
		err = ValidateIncidentViewExtended(result.Projected)
	case "source":
		err = ValidateIncidentViewSource(result.Projected)
	default:
...
// ValidateIncidentList runs the validations defined on the viewed result type
// IncidentList.
func ValidateIncidentList(result *IncidentList) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateIncidentListView(result.Projected)
	default:
...
// ValidateIncidentView runs the validations defined on IncidentView using the
// "default" view.
...
// ValidateIncidentViewExtended runs the validations defined on IncidentView
...
func ValidateIncidentViewExtended(result *IncidentView) (err error) {
	...
	for _, e := range result.AvailableActions {
		if e != nil {
			if err2 := ValidateActionView(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
	for _, e := range result.ViolationDataFields {
		if e != nil {
			if err2 := ValidateDataFieldView(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
...
// ValidateIncidentViewSource runs the validations defined on IncidentView
...
// ValidateDataFieldView runs the validations defined on DataFieldView.
func ValidateDataFieldView(result *DataFieldView) (err error) {
	if result.Key == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("key", "result"))
	}
	return
...
// ValidateActionView runs the validations defined on ActionView using the
// "default" view.
func ValidateActionView(result *ActionView) (err error) {
	if result.ID == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("id", "result"))
	}
	if result.Type == nil {
	...
	if result.Kind != nil {
		if !(*result.Kind == "gov#action") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.kind", *result.Kind, []interface{}{"gov#action"}))
		}
	}
	return
}

// ValidateIncidentListView runs the validations defined on IncidentListView
// using the "default" view.
func ValidateIncidentListView(result *IncidentListView) (err error) {
	...
	if result.Items != nil {
		if err2 := ValidateIncidentCollectionView(result.Items); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// ValidateIncidentCollectionView runs the validations defined on
// IncidentCollectionView using the "default" view.
func ValidateIncidentCollectionView(result IncidentCollectionView) (err error) {
	for _, item := range result {
		if err2 := ValidateIncidentView(item); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// ValidateIncidentCollectionViewExtended runs the validations defined on
// IncidentCollectionView using the "extended" view.
func ValidateIncidentCollectionViewExtended(result IncidentCollectionView) (err error) {
	for _, item := range result {
		if err2 := ValidateIncidentViewExtended(item); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// ValidateIncidentCollectionViewSource runs the validations defined on
// IncidentCollectionView using the "source" view.
func ValidateIncidentCollectionViewSource(result IncidentCollectionView) (err error) {
	for _, item := range result {
		if err2 := ValidateIncidentViewSource(item); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
