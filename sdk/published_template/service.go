...
// newPublishedTemplateListView projects result type PublishedTemplateList into
...
// PublishedTemplateList into projected type PublishedTemplateListView using
// the "extended" view.
...
// PublishedTemplateCollection into projected type
...
// *publishedtemplateviews.UserView.
func unmarshalUserViewToUser(v *publishedtemplateviews.UserView) *User {
	if v == nil {
		return nil
	}
	res := &User{
...
// type *publishedtemplateviews.RegexpView.
func unmarshalRegexpViewToRegexp(v *publishedtemplateviews.RegexpView) *Regexp {
	if v == nil {
		return nil
	}
	res := &Regexp{
...
// marshalUserToUserView builds a value of type
// *publishedtemplateviews.UserView from a value of type *User.
func marshalUserToUserView(v *User) *publishedtemplateviews.UserView {
	if v == nil {
		return nil
	}
...
func marshalRegexpToRegexpView(v *Regexp) *publishedtemplateviews.RegexpView {
	if v == nil {
		return nil
	}
