...
func ValidatePolicyAggregateNonCatalogResponseBody(body *PolicyAggregateNonCatalogResponseBody) (err error) {
	...
	if err2 := ValidatePolicyAggregateNonCatalogItemCollectionResponseBody(body.Items); err2 != nil {
		err = goa.MergeErrors(err, err2)
	}
	if body.Kind != nil {
...
func ValidateIncidentAggregateResponseBody(body *IncidentAggregateResponseBody) (err error) {
	...
	if err2 := ValidateIncidentAggregateItemCollectionResponseBody(body.Items); err2 != nil {
		err = goa.MergeErrors(err, err2)
	}
	if body.CreatedAt != nil {
		err = goa.MergeErrors(err, goa.ValidateFormat("body.created_at", *body.CreatedAt, goa.FormatDateTime))
