...
func NewCreateResponseBody(res *appliedpolicyviews.AppliedPolicyView) *CreateResponseBody {
	...
	if res.PolicyTemplate != nil {
		body.PolicyTemplate = marshalPolicyTemplateViewToPolicyTemplateResponseBodyLink(res.PolicyTemplate)
	}
	if res.PublishedTemplate != nil {
		body.PublishedTemplate = marshalPublishedTemplateViewToPublishedTemplateResponseBodyLink(res.PublishedTemplate)
	}
	if res.Info != nil {
...
func NewCreateResponseBodySource(res *appliedpolicyviews.AppliedPolicyView) *CreateResponseBodySource {
	...
	if res.PolicyTemplate != nil {
		body.PolicyTemplate = marshalPolicyTemplateViewToPolicyTemplateResponseBodySource(res.PolicyTemplate)
	}
	if res.PublishedTemplate != nil {
		body.PublishedTemplate = marshalPublishedTemplateViewToPublishedTemplateResponseBodySource(res.PublishedTemplate)
	}
	return body
}
...
// NewShowLogOKResponseBody builds the HTTP response body from the result of
// the "show_log" endpoint of the "AppliedPolicy" service.
func NewShowLogOKResponseBody(res *appliedpolicyviews.AppliedPolicyLogView) *ShowLogOKResponseBody {
...
func NewIndexOKResponseBody(res *appliedpolicyviews.AppliedPolicyListView) *IndexOKResponseBody {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = &AppliedPolicyResponseBody{
				ID:          *val.ID,
				Name:        *val.Name,
				Href:        *val.Href,
			...
			if val.PolicyTemplate != nil {
				body.Items[i].PolicyTemplate = marshalPolicyTemplateViewToPolicyTemplateResponseBodyLink(val.PolicyTemplate)
			}
			if val.PublishedTemplate != nil {
				body.Items[i].PublishedTemplate = marshalPublishedTemplateViewToPublishedTemplateResponseBodyLink(val.PublishedTemplate)
			}
			if val.Info != nil {
...
func NewIndexOKResponseBodyLink(res *appliedpolicyviews.AppliedPolicyListView) *IndexOKResponseBodyLink {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = &AppliedPolicyResponseBodyLink{
				ID:        *val.ID,
				Name:      *val.Name,
				Href:      *val.Href,
				CreatedAt: val.CreatedAt,
...
func NewCreatePayload(body *CreateRequestBody, projectID uint, apiVersion string, token *string) *appliedpolicy.CreatePayload {
	...
	if body.Options != nil {
		...
		for i, val := range body.Options {
			v.Options[i] = &appliedpolicy.ConfigurationOptionCreateType{
				Name:  *val.Name,
				Value: *val.Value,
			}
		}
...
func NewDeletePayload(projectID uint, policyID string, apiVersion string, token *string) *appliedpolicy.DeletePayload {
	return &appliedpolicy.DeletePayload{
		ProjectID:  projectID,
		PolicyID:   policyID,
...
func NewShowPayload(projectID uint, policyID string, view *string, apiVersion string, token *string) *appliedpolicy.ShowPayload {
	return &appliedpolicy.ShowPayload{
		ProjectID:  projectID,
		PolicyID:   policyID,
		View:       view,
		APIVersion: apiVersion,
...
func NewShowStatusPayload(projectID uint, policyID string, apiVersion string, token *string) *appliedpolicy.ShowStatusPayload {
	return &appliedpolicy.ShowStatusPayload{
		ProjectID:  projectID,
		PolicyID:   policyID,
		APIVersion: apiVersion,
		Token:      token,
...
func NewShowLogPayload(projectID uint, policyID string, apiVersion string, etag *string, token *string) *appliedpolicy.ShowLogPayload {
	return &appliedpolicy.ShowLogPayload{
		ProjectID:  projectID,
		PolicyID:   policyID,
		APIVersion: apiVersion,
		Etag:       etag,
...
func NewIndexPayload(projectID uint, view *string, name []string, apiVersion string, etag *string, token *string) *appliedpolicy.IndexPayload {
	return &appliedpolicy.IndexPayload{
		ProjectID:  projectID,
		View:       view,
		Name:       name,
		APIVersion: apiVersion,
...
func NewEvaluatePayload(projectID uint, policyID string, apiVersion string, token *string) *appliedpolicy.EvaluatePayload {
	return &appliedpolicy.EvaluatePayload{
		ProjectID:  projectID,
		PolicyID:   policyID,
		APIVersion: apiVersion,
		Token:      token,
...
// Validate runs the validations defined on AppliedPolicyResponseBodyCollection.
func (body AppliedPolicyResponseBodyCollection) Validate() (err error) {
	for _, e := range body {
		if e != nil {
...
// AppliedPolicyResponseBodyLinkCollection.
func (body AppliedPolicyResponseBodyLinkCollection) Validate() (err error) {
	for _, e := range body {
		if e != nil {
			if err2 := e.Validate(); err2 != nil {
				err = goa.MergeErrors(err, err2)
