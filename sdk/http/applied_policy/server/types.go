...
// ValidateAppliedPolicyResponseBodyCollection runs the validations defined on
// AppliedPolicyResponseBodyCollection
func ValidateAppliedPolicyResponseBodyCollection(body AppliedPolicyResponseBodyCollection) (err error) {
	for _, e := range body {
		if e != nil {
...
// ValidateAppliedPolicyResponseBodyLinkCollection runs the validations defined
// on AppliedPolicyResponseBodyLinkCollection
func ValidateAppliedPolicyResponseBodyLinkCollection(body AppliedPolicyResponseBodyLinkCollection) (err error) {
	for _, e := range body {
		if e != nil {
			if err2 := ValidateAppliedPolicyResponseBodyLink(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
