...
func DecodeUploadResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusOK:
			...
			vres := &policytemplateviews.PolicyTemplate{Projected: p, View: view}
...
func DecodeIndexResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusNotModified:
			...
			p.NotModified = &tmp
			view := resp.Header.Get("goa-view")
			vres := &policytemplateviews.PolicyTemplateList{Projected: p, View: view}
...
// unmarshalDataResponseToPolicytemplateData builds a value of type
// *policytemplate.Data from a value of type *DataResponse.
func unmarshalDataResponseToPolicytemplateData(v *DataResponse) *policytemplate.Data {
	res := &policytemplate.Data{
		Name: *v.Name,
		Type: *v.Type,
		Data: v.Data,
	}
