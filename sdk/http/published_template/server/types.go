...
func NewShowResponseBody(res *publishedtemplateviews.PublishedTemplateView) *ShowResponseBody {
	...
	if res.CreatedBy != nil {
		body.CreatedBy = marshalPublishedtemplateviewsUserViewToUserResponseBody(res.CreatedBy)
	}
	if res.UpdatedBy != nil {
		body.UpdatedBy = marshalPublishedtemplateviewsUserViewToUserResponseBody(res.UpdatedBy)
	}
	...
	if res.HiddenBy != nil {
		body.HiddenBy = marshalPublishedtemplateviewsUserViewToUserResponseBody(res.HiddenBy)
	}
	return body
}
...
func NewShowResponseBodyExtended(res *publishedtemplateviews.PublishedTemplateView) *ShowResponseBodyExtended {
	...
	if res.Permissions != nil {
		...
		for key, val := range res.Permissions {
			tk := key
			body.Permissions[tk] = marshalPublishedtemplateviewsPermissionViewToPermissionResponseBody(val)
		}
	}
	if res.RequiredRoles != nil {
		body.RequiredRoles = make([]string, len(res.RequiredRoles))
	...
	if res.Parameters != nil {
		...
		for key, val := range res.Parameters {
			tk := key
			body.Parameters[tk] = marshalPublishedtemplateviewsParameterViewToParameterResponseBody(val)
		}
	}
	if res.HiddenBy != nil {
		body.HiddenBy = marshalPublishedtemplateviewsUserViewToUserResponseBody(res.HiddenBy)
	...
	if res.Credentials != nil {
		...
		for key, val := range res.Credentials {
			tk := key
			body.Credentials[tk] = marshalPublishedtemplateviewsCredentialsViewToCredentialsResponseBody(val)
		}
	}
	return body
}
...
func NewIndexOKResponseBody(res *publishedtemplateviews.PublishedTemplateListView) *IndexOKResponseBody {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = marshalPublishedtemplateviewsPublishedTemplateViewToPublishedTemplateResponseBody(val)
		}
	}
	return body
}
...
func NewIndexOKResponseBodyExtended(res *publishedtemplateviews.PublishedTemplateListView) *IndexOKResponseBodyExtended {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = marshalPublishedtemplateviewsPublishedTemplateViewToPublishedTemplateResponseBodyExtended(val)
		}
	}
	return body
}
...
// ValidatePublishedTemplateResponseBodyCollection runs the validations defined
// on PublishedTemplateResponseBodyCollection
func ValidatePublishedTemplateResponseBodyCollection(body PublishedTemplateResponseBodyCollection) (err error) {
	for _, e := range body {
		if e != nil {
...
// ValidatePublishedTemplateResponseBodyExtendedCollection runs the validations
// defined on PublishedTemplateResponseBodyExtendedCollection
func ValidatePublishedTemplateResponseBodyExtendedCollection(body PublishedTemplateResponseBodyExtendedCollection) (err error) {
	for _, e := range body {
		if e != nil {
			if err2 := ValidatePublishedTemplateResponseBodyExtended(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
...
// ValidatePublishedTemplateResponseBodyExtended runs the validations defined
// on PublishedTemplateResponseBodyExtended
func ValidatePublishedTemplateResponseBodyExtended(body *PublishedTemplateResponseBodyExtended) (err error) {
	if body.PolicyTemplateURL != nil {
		err = goa.MergeErrors(err, goa.ValidateFormat("body.policy_template_url", *body.PolicyTemplateURL, goa.FormatURI))
	}
	if body.DocLink != nil {
