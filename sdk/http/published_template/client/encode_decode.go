...
// *publishedtemplateviews.UserView from a value of type *UserResponseBody.
func unmarshalUserResponseBodyToUserView(v *UserResponseBody) *publishedtemplateviews.UserView {
	if v == nil {
		return nil
	}
...
// *publishedtemplateviews.RegexpView from a value of type *RegexpResponseBody.
func unmarshalRegexpResponseBodyToRegexpView(v *RegexpResponseBody) *publishedtemplateviews.RegexpView {
	if v == nil {
		return nil
	}
