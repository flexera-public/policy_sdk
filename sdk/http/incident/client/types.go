...
// NewRunActionRequestBody builds the HTTP request body from the payload of the
// "run_action" endpoint of the "Incident" service.
func NewRunActionRequestBody(p *incident.RunActionPayload) *RunActionRequestBody {
	...
	if p.Options != nil {
		...
		for i, val := range p.Options {
			body.Options[i] = marshalIncidentConfigurationOptionCreateTypeToConfigurationOptionCreateTypeRequestBody(val)
		}
	}
	return body
}
...
func NewShowIncidentOK(body *ShowOKResponseBody, etag string) *incidentviews.IncidentView {
	v := &incidentviews.IncidentView{
		...
		Detail:              body.Detail,
		ViolationData:       body.ViolationData,
	...
	if body.Project != nil {
		v.Project = unmarshalProjectResponseBodyToIncidentviewsProjectView(body.Project)
	}
	if body.AppliedPolicy != nil {
		v.AppliedPolicy = unmarshalAppliedPolicyResponseBodyToIncidentviewsAppliedPolicyView(body.AppliedPolicy)
	}
	if body.ViolationDataFields != nil {
		v.ViolationDataFields = make([]*incidentviews.DataFieldView, len(body.ViolationDataFields))
		for i, val := range body.ViolationDataFields {
			v.ViolationDataFields[i] = unmarshalDataFieldResponseBodyToIncidentviewsDataFieldView(val)
		}
	}
	if body.ResolvedBy != nil {
		v.ResolvedBy = unmarshalUserResponseBodyToIncidentviewsUserView(body.ResolvedBy)
	}
	if body.Options != nil {
		v.Options = make([]*incidentviews.ConfigurationOptionView, len(body.Options))
		for i, val := range body.Options {
			v.Options[i] = unmarshalConfigurationOptionResponseBodyToIncidentviewsConfigurationOptionView(val)
		}
	}
	if body.AvailableActions != nil {
		v.AvailableActions = make([]*incidentviews.ActionView, len(body.AvailableActions))
		for i, val := range body.AvailableActions {
			v.AvailableActions[i] = unmarshalActionResponseBodyToIncidentviewsActionView(val)
		}
	}
	v.Etag = &etag
...
func NewIndexIncidentListOK(body *IndexOKResponseBody, etag string) *incidentviews.IncidentListView {
	...
	if body.Items != nil {
		...
		for i, val := range body.Items {
			v.Items[i] = unmarshalIncidentResponseBodyToIncidentviewsIncidentView(val)
		}
	}
	v.Etag = &etag
...
func NewIndexEscalationsEscalationsOK(body *IndexEscalationsResponseBody) *incidentviews.EscalationsView {
	...
	if body.Escalations != nil {
		...
		for i, val := range body.Escalations {
			v.Escalations[i] = unmarshalEscalationResponseBodyToIncidentviewsEscalationView(val)
		}
	}
...
func NewIndexResolutionsResolutionsOK(body *IndexResolutionsResponseBody) *incidentviews.ResolutionsView {
	...
	if body.Resolutions != nil {
		...
		for i, val := range body.Resolutions {
			v.Resolutions[i] = unmarshalResolutionResponseBodyToIncidentviewsResolutionView(val)
		}
	}
...
// NewRunActionResultAccepted builds a "Incident" service "run_action" endpoint
// result from a HTTP "Accepted" response.
func NewRunActionResultAccepted(location string) *incident.RunActionResult {
	v := &incident.RunActionResult{}
	v.Location = location

	return v
}

// NewRunActionNotFound builds a Incident service run_action endpoint not_found
// error.
func NewRunActionNotFound(body *RunActionNotFoundResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionUnprocessableEntity builds a Incident service run_action
// endpoint unprocessable_entity error.
func NewRunActionUnprocessableEntity(body *RunActionUnprocessableEntityResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionUnauthorized builds a Incident service run_action endpoint
// unauthorized error.
func NewRunActionUnauthorized(body *RunActionUnauthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionForbidden builds a Incident service run_action endpoint
// forbidden error.
func NewRunActionForbidden(body *RunActionForbiddenResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionBadRequest builds a Incident service run_action endpoint
// bad_request error.
func NewRunActionBadRequest(body *RunActionBadRequestResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionBadGateway builds a Incident service run_action endpoint
// bad_gateway error.
func NewRunActionBadGateway(body *RunActionBadGatewayResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionInternalError builds a Incident service run_action endpoint
// internal_error error.
func NewRunActionInternalError(body *RunActionInternalErrorResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewRunActionConflict builds a Incident service run_action endpoint conflict
// error.
func NewRunActionConflict(body *RunActionConflictResponseBody, location string) *incident.Conflict {
	v := &incident.Conflict{}
	if body.Message != nil {
		v.Message = *body.Message
	}
	if body.Message == nil {
		v.Message = "The requested action is currently running on the incident"
	}
	v.Location = location
...
// ValidateResolvePreconditionFailedResponseBody runs the validations defined
// on resolve_precondition_failed_response_body
func ValidateResolvePreconditionFailedResponseBody(body *ResolvePreconditionFailedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateResolveBadGatewayResponseBody runs the validations defined on
// resolve_bad_gateway_response_body
func ValidateResolveBadGatewayResponseBody(body *ResolveBadGatewayResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateResolveInternalErrorResponseBody runs the validations defined on
// resolve_internal_error_response_body
func ValidateResolveInternalErrorResponseBody(body *ResolveInternalErrorResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionNotFoundResponseBody runs the validations defined on
// run_action_not_found_response_body
func ValidateRunActionNotFoundResponseBody(body *RunActionNotFoundResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionUnprocessableEntityResponseBody runs the validations
// defined on run_action_unprocessable_entity_response_body
func ValidateRunActionUnprocessableEntityResponseBody(body *RunActionUnprocessableEntityResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionUnauthorizedResponseBody runs the validations defined on
// run_action_unauthorized_response_body
func ValidateRunActionUnauthorizedResponseBody(body *RunActionUnauthorizedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionForbiddenResponseBody runs the validations defined on
// run_action_forbidden_response_body
func ValidateRunActionForbiddenResponseBody(body *RunActionForbiddenResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionBadRequestResponseBody runs the validations defined on
// run_action_bad_request_response_body
func ValidateRunActionBadRequestResponseBody(body *RunActionBadRequestResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionBadGatewayResponseBody runs the validations defined on
// run_action_bad_gateway_response_body
func ValidateRunActionBadGatewayResponseBody(body *RunActionBadGatewayResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateRunActionInternalErrorResponseBody runs the validations defined on
// run_action_internal_error_response_body
func ValidateRunActionInternalErrorResponseBody(body *RunActionInternalErrorResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateDataFieldResponseBody runs the validations defined on
// DataFieldResponseBody
func ValidateDataFieldResponseBody(body *DataFieldResponseBody) (err error) {
	if body.Key == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("key", "body"))
	}
	return
...
func ValidateActionResponseBody(body *ActionResponseBody) (err error) {
	if body.ID == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("id", "body"))
	}
	if body.Type == nil {
	...
	if body.Kind != nil {
		if !(*body.Kind == "gov#action") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.kind", *body.Kind, []interface{}{"gov#action"}))
		}
	}
	return
}

// ValidateIncidentCollectionResponseBody runs the validations defined on
// IncidentCollectionResponseBody
func ValidateIncidentCollectionResponseBody(body IncidentCollectionResponseBody) (err error) {
	for _, e := range body {
		if e != nil {
...
func ValidateIncidentResponseBody(body *IncidentResponseBody) (err error) {
	...
	for _, e := range body.ViolationDataFields {
		if e != nil {
			if err2 := ValidateDataFieldResponseBody(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
	...
	for _, e := range body.AvailableActions {
		if e != nil {
			if err2 := ValidateActionResponseBody(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
