...
func NewShowOKResponseBody(res *incidentviews.IncidentView) *ShowOKResponseBody {
	...
	if res.Project != nil {
		body.Project = marshalProjectViewToProjectResponseBody(res.Project)
	}
	if res.AppliedPolicy != nil {
		body.AppliedPolicy = marshalAppliedPolicyViewToAppliedPolicyResponseBodyLink(res.AppliedPolicy)
	}
	if res.ResolvedBy != nil {
		body.ResolvedBy = marshalUserViewToUserResponseBody(res.ResolvedBy)
	}
	if res.Options != nil {
...
func NewShowOKResponseBodySource(res *incidentviews.IncidentView) *ShowOKResponseBodySource {
	...
	if res.AppliedPolicy != nil {
		body.AppliedPolicy = marshalAppliedPolicyViewToAppliedPolicyResponseBodySource(res.AppliedPolicy)
	}
	return body
}
...
func NewIndexOKResponseBody(res *incidentviews.IncidentListView) *IndexOKResponseBody {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = &IncidentResponseBody{
				ID:                 *val.ID,
				Href:               val.Href,
				Summary:            val.Summary,
			...
			if val.Project != nil {
				body.Items[i].Project = marshalProjectViewToProjectResponseBody(val.Project)
			}
			if val.AppliedPolicy != nil {
				body.Items[i].AppliedPolicy = marshalAppliedPolicyViewToAppliedPolicyResponseBodyLink(val.AppliedPolicy)
			}
			if val.ResolvedBy != nil {
				body.Items[i].ResolvedBy = marshalUserViewToUserResponseBody(val.ResolvedBy)
			}
			if val.Options != nil {
...
func NewIndexOKResponseBodyExtended(res *incidentviews.IncidentListView) *IndexOKResponseBodyExtended {
	...
	if res.Items != nil {
		...
		for i, val := range res.Items {
			body.Items[i] = &IncidentResponseBodyExtended{
				ID:                 *val.ID,
				Href:               val.Href,
				Summary:            val.Summary,
				Detail:             val.Detail,
...
func NewIndexEscalationsResponseBody(res *incidentviews.EscalationsView) *IndexEscalationsResponseBody {
	...
	if res.Escalations != nil {
		...
		for i, val := range res.Escalations {
			body.Escalations[i] = &EscalationResponseBody{
				Status: *val.Status,
				Name:   *val.Name,
			}
			if val.Actions != nil {
				body.Escalations[i].Actions = make([]*EscalationActionResponseBody, len(val.Actions))
				for j, val := range val.Actions {
					body.Escalations[i].Actions[j] = &EscalationActionResponseBody{
						Type:        *val.Type,
						Status:      *val.Status,
					...
					if val.ApprovalRequest != nil {
						body.Escalations[i].Actions[j].ApprovalRequest = marshalApprovalRequestViewToApprovalRequestResponseBodyExtended(val.ApprovalRequest)
					}
				}
			}
		}
...
func NewIndexResolutionsResponseBody(res *incidentviews.ResolutionsView) *IndexResolutionsResponseBody {
	...
	if res.Resolutions != nil {
		...
		for i, val := range res.Resolutions {
			body.Resolutions[i] = &ResolutionResponseBody{
				Status: *val.Status,
				Name:   *val.Name,
			}
			if val.Actions != nil {
				body.Resolutions[i].Actions = make([]*ResolutionActionResponseBody, len(val.Actions))
				for j, val := range val.Actions {
					body.Resolutions[i].Actions[j] = &ResolutionActionResponseBody{
						Type:        *val.Type,
						Status:      *val.Status,
						StartedAt:   val.StartedAt,
						FinishedAt:  val.FinishedAt,
					...
					if val.ApprovalRequest != nil {
						body.Resolutions[i].Actions[j].ApprovalRequest = marshalApprovalRequestViewToApprovalRequestResponseBodyExtended(val.ApprovalRequest)
					}
				}
			}
		}
...
// Validate runs the validations defined on AppliedPolicyResponseBodyLink.
func (body *AppliedPolicyResponseBodyLink) Validate() (err error) {
...
// Validate runs the validations defined on PolicyTemplateResponseBodyLink.
func (body *PolicyTemplateResponseBodyLink) Validate() (err error) {
...
// Validate runs the validations defined on PublishedTemplateResponseBodyLink.
func (body *PublishedTemplateResponseBodyLink) Validate() (err error) {
...
// Validate runs the validations defined on AppliedPolicyResponseBodySource.
func (body *AppliedPolicyResponseBodySource) Validate() (err error) {
	err = goa.MergeErrors(err, goa.ValidatePattern("body.href", body.Href, "^/api/governance/projects/[0-9]+/applied_policies/[0-9a-f]+$"))
	if body.PolicyTemplate != nil {
		if err2 := body.PolicyTemplate.Validate(); err2 != nil {
			err = goa.MergeErrors(err, err2)
...
// Validate runs the validations defined on PolicyTemplateResponseBodySource.
func (body *PolicyTemplateResponseBodySource) Validate() (err error) {
	err = goa.MergeErrors(err, goa.ValidatePattern("body.href", body.Href, "^/api/governance/projects/[0-9]+/policy_templates/[0-9a-f]+$"))
	if !(body.Kind == "gov#policy_template") {
		err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.kind", body.Kind, []interface{}{"gov#policy_template"}))
	}
...
// Validate runs the validations defined on PublishedTemplateResponseBodySource.
func (body *PublishedTemplateResponseBodySource) Validate() (err error) {
	err = goa.MergeErrors(err, goa.ValidatePattern("body.href", body.Href, "^/api/governance/orgs/[0-9]+/published_templates/[0-9a-f]+$"))
	if !(body.Kind == "gov#published_template") {
		err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.kind", body.Kind, []interface{}{"gov#published_template"}))
	}
...
// Validate runs the validations defined on IncidentResponseBodyCollection.
func (body IncidentResponseBodyCollection) Validate() (err error) {
	for _, e := range body {
		if e != nil {
...
// IncidentResponseBodyExtendedCollection.
func (body IncidentResponseBodyExtendedCollection) Validate() (err error) {
	for _, e := range body {
		if e != nil {
			if err2 := e.Validate(); err2 != nil {
				err = goa.MergeErrors(err, err2)
...
// Validate runs the validations defined on IncidentResponseBodyExtended.
func (body *IncidentResponseBodyExtended) Validate() (err error) {
	if body.Href != nil {
		err = goa.MergeErrors(err, goa.ValidatePattern("body.href", *body.Href, "^/api/governance/projects/[0-9]+/incidents/[0-9a-f]+$"))
	}
	if body.AppliedPolicy != nil {
