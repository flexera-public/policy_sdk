...
// EncodeRunActionResponse returns an encoder for responses returned by the
// Incident run_action endpoint.
func EncodeRunActionResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*incident.RunActionResult)
...
// DecodeRunActionRequest returns a decoder for requests sent to the Incident
// run_action endpoint.
func DecodeRunActionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		var (
		...
		err = ValidateRunActionRequestBody(&body)
		if err != nil {
			return nil, err
		}
		...
		payload := NewRunActionPayload(&body, projectID, incidentID, actionID, apiVersion, token)
		if payload.Token != nil {
			if strings.Contains(*payload.Token, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.Token, " ", 2)[1]
...
// EncodeRunActionError returns an encoder for errors returned by the
// run_action Incident endpoint.
func EncodeRunActionError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		en, ok := v.(ErrorNamer)
		if !ok {
		...
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewRunActionNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", "not_found")
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "unprocessable_entity":
			...
			if formatter != nil {
				...
				body = NewRunActionUnprocessableEntityResponseBody(res)
			}
			w.Header().Set("goa-error", "unprocessable_entity")
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewRunActionUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", "unauthorized")
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewRunActionForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", "forbidden")
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewRunActionBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad_request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "bad_gateway":
			...
			if formatter != nil {
				...
				body = NewRunActionBadGatewayResponseBody(res)
			}
			w.Header().Set("goa-error", "bad_gateway")
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
		case "internal_error":
			...
			if formatter != nil {
				...
				body = NewRunActionInternalErrorResponseBody(res)
			}
			w.Header().Set("goa-error", "internal_error")
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "conflict":
			res := v.(*incident.Conflict)
			enc := encoder(ctx, w)
			var body interface{}
			if formatter != nil {
				body = formatter(res)
			} else {
				body = NewRunActionConflictResponseBody(res)
			}
			w.Header().Set("Location", res.Location)
...
// marshalIncidentviewsDataFieldViewToDataFieldResponseBody builds a value of
// type *DataFieldResponseBody from a value of type
// *incidentviews.DataFieldView.
func marshalIncidentviewsDataFieldViewToDataFieldResponseBody(v *incidentviews.DataFieldView) *DataFieldResponseBody {
	if v == nil {
		return nil
	}
	res := &DataFieldResponseBody{
		Key:    *v.Key,
		Label:  v.Label,
		Format: v.Format,
	}
...
// marshalIncidentviewsActionViewToActionResponseBody builds a value of type
// *ActionResponseBody from a value of type *incidentviews.ActionView.
func marshalIncidentviewsActionViewToActionResponseBody(v *incidentviews.ActionView) *ActionResponseBody {
	if v == nil {
		return nil
	}
	res := &ActionResponseBody{
		ID:          *v.ID,
		Type:        *v.Type,
		Label:       v.Label,
...
// unmarshalConfigurationOptionCreateTypeRequestBodyToIncidentConfigurationOptionCreateType
...
func unmarshalConfigurationOptionCreateTypeRequestBodyToIncidentConfigurationOptionCreateType(v *ConfigurationOptionCreateTypeRequestBody) *incident.ConfigurationOptionCreateType {
	if v == nil {
		return nil
	}
